...
async function getSchemaColumns(connectionName, schema, table) {
    return (0, http_1.fetchJson)(`/api/schema/columns?connectionName=${encodeURIComponent(connectionName)}&schema=${encodeURIComponent(schema)}&table=${encodeURIComponent(table)}`);
}
